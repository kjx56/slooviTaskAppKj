...
var f2 = NASHORN_BUG ? function propertyIsEnumerable(V) {
...
var _class2;
var _temp;
var ReactTooltip = staticMethods(_class = windowListener(_class = customEvent(_class = isCapture(_class = getEffect(_class = bodyMode(_class = trackRemoval(_class = (_temp = _class2 = function(_React$Component) {
...
// dep:react-tooltip
var react_tooltip_default = index_es_default;
export {
  react_tooltip_default as default
};
/*
object-assign
(c) Sindre Sorhus
